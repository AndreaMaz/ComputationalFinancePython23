...
def minimizeExpectedLoss(lossFunction, consumptionFunction, probabilityFunctions,
    ...
    def computeExpectedLossForEmissionsReduction(emissionsReduction):
    ...
    res = minimize(computeExpectedLossForEmissionsReduction, x0 = 0.5, method='nelder-mead',
