...
productionFunction = lambda x : 0.01 * x
...
systemGenerator = SystemEvolution(numberOfSimulations, timeStep, finalTime, initialValues,
                 ...
                 costFunction, productionFunction, impactOfNaturalDisaster, 1897)
...
for firmIndex in range(0,numberOfCompanies):
    plt.plot(realizations[:, firmIndex, 0])
