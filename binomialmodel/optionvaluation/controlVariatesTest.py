"""
Here we test how the use of control variates can make the approximation of the valuation of an american put option better.
...
#we want to plot a line representing the analytic price of the European put
...
plt.legend(('american, control variates','american, binomial model','european, binomial model','european, analytic'))
